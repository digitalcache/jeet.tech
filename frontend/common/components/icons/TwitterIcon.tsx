...
export const TwitterIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path className="fill-white" d="M21.153 8H23.7139L18.119 14.3946L24.7009 23.0961H19.5473L15.5109 17.8187L10.8923 23.0961H8.32979L14.314 16.2564L8 8H13.2844L16.933 12.8238L21.153 8ZM20.2542 21.5633H21.6732L12.5133 9.45232H10.9906L20.2542 21.5633Z" />
    <defs>
